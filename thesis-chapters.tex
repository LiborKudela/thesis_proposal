...
\label{struktura}
\newacronym{czt}{CZT}{Centrální zásobování teplem}
...
\end{figure}
\newacronym{pdr}{PDR}{Parciální diferenciální rovnice}
...
\end{figure}
\newacronym{uwt}{UWT}{Rovnoměrná teplota stěny z angl. uniform wall
                      temperature}
\newacronym{uhf}{UHF}{Rovnoměrná hustota tepleného toku z angl. uniform heat
                      flux}
...
\newacronym{odr}{ODR}{Ordinární diferenciální rovnice}
\newacronym{mkd}{MKD}{Metoda konečných diferencí}
\newacronym{mkp}{MKP}{Metoda konečných prvků}
\newacronym{mko}{MKO}{Metoda konečných objemů}
...
\newacronym{cpu}{CPU}{Centrální procesorová jednotka z angl. Central processing
                      unit}
\newacronym{sundials}{SUNDIALS}{Suite of Nonlinear and Differential/Algebraic
                                Equation Solvers}
...
\end{itemize}
\newacronym{msl}{MSL}{Standartizovaná knihovna Modelica}
\newacronym{if97}{IF97}{Industriální formulace vlastností vody z roku 1997}
\newacronym{iapws}{IAPWS}{Mezinárodní asociace pro vlastnosti vody a vodní páry}
...
\newacronym{fmi}{FMI}{Standart výměny a kosimulace modelů - angl. functional
                      mock-up interface}
\newacronym{fmu}{FMU}{Jednotlivý model standardu \acrshort{fmi} - angl.
                      functional mock-up unit}
\newacronym{omc}{OMC}{Open Modelica kompilátor z angl. Open Modelica compiler}
...
\newacronym{nn}{NN}{Neuronová síť z angl. neural network}
Poměrně velký úspěch v této oblasti zaznamenaly tzv. neuronové sítě
...
\label{sec:opt_alg}
\newacronym{gld}{GLD}{Optimalizace bez gradientu z angl. gradientless descend}
...
Například model akumulace pro nadzemní teplárenské potrubí je možné přímočaře
...
\begin{itemize}
  ...
  \item
    ...
    jejich funkčnost.
\end{itemize}
\newacronym{lofi}{LOFI}{Název navrhovaného optimalizačního nástoje}
...
\subsection*{Dílčí kroky vedoucí k dosažení cíle práce}
\begin{itemize}
  \item
...
\begin{equation}
  ...
  \end{gathered}
\end{equation}
kde \(\boldsymbol{M}\) je matice tepelné kapacity, \(\boldsymbol{K}\) je matice
...
\label{sec:tool_LOFI}
\newacronym{mpi}{MPI}{Komunikační rozhraní pro cluster - angl. message passing interface}
...
\newacronym{api}{API}{Aplikační rozhraní z angl. aplication interface}
\newacronym{pso}{PSO}{Hejnový optimalizační algoritmus z angl. Particle swarm optimizer}
\newacronym{grapso}{GRAPSO}{\acrshort{pso} s náhodnou adaptací}
\newacronym{oples}{OPLES}{tzv. One plus lambda}
