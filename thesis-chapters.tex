...
metody spolu s aspekty, ovlivňující numerickou efektivnost simulací.
...
je nutno korektně matematicky zachytit tuto tepelnou dynamiku v tomto okolí
(viz~kapitola \ref{sec:SurroundingMass}).
...
gradient byl určen algoritmickou zpětnou propagací skrze ODR solver (což je
